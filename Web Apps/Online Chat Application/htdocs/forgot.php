<?php
   ...
   if ( $sameUserRow > 0 ) {
      ...
      $username = "bubblechatcorp@gmail.com";
      $password = "@bubblechat";
      $port = "465";
      $to = $email;
      $email_from = "bubblechatcorp@gmail.com";
      $email_subject = "Password Reset Link ( BubbleChat )" ;
      $email_body =
      "Hello, " . $user . ",
      ...
      https://bubblechat.hopto.org/reset.php?email=".$email."&token=".$token;
...
<head>
   ...
   <title>BubbleChat - Forgot Password</title>
</head>
               ...
               <div class="container-fiuld">
                  <div class="row">
                     <div class="col-md-3 align-self-center">
                        <img src="images/bubblechat.png" width="50" height="50" alt="BubbleChat's icon">
                     </div>
